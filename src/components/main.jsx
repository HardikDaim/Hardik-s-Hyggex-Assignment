    ...
    <div className="mx-auto container">
      <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          <li class="inline-flex items-center pl-4 py-4">
            <a
              href="#"
          ...
          <li>
            <div class="flex items-center ">
              ...
              <a
                href="#"
                class="ms-1 text-sm font-bold text-blue-800 hover:text-blue-800  md:ms-2  "
              >
      ...
      <div className="pl-4">
        <div className="text-3xl pt-5 font-bold text-blue-800">
          Relations and Functions (Mathematics)
        </div>
      </div>
      <div className="pl-4 my-5 flex gap-x-6  justify-center">
        <div className="text-blue-800 p-2 font-bold border-b-2 border-blue-700">
          Study
        </div>
        <div className="text-gray-500 p-2 ">Quiz</div>
        <div className="text-gray-500 p-2 ">Test</div>
        <div className="text-gray-500 p-2 ">Game</div>
        <div className="text-gray-500 p-2 ">Others</div>
      </div>
      <div className="flex justify-center">
        <div width="600" height="350" className="relative">
          ...
          <div className="absolute top-4 right-2 m-4">
            {/* Sound icon */}
            <svg
              viewBox="0 0 24 24"
              height="20px"
          ...
          <div className="absolute top-1/3 mt-8 left-1/3  text-white text-lg font-bold">
            {/* Text in the center of canvas */}
            <div className="font-bold text-3xl">9 + 6 + 7x - 2x - 3</div>
          </div>
        </div>
      </div>

      <div className="pl-4 my-5 flex gap-x-8  justify-center">
        <div className="pr-10">
          <svg
            fill="#1E40AF"
            height="60px"
        ...
        <div className="p-3 font-semibold text-lg">01/10</div>
        ...
        <div>
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path d="M464,256c0-114.87-93.13-208-208-208S48,141.13,48,256s93.13,208,208,208S464,370.87,464,256ZM240,336.09,303.58,272H154V240H303.58L240,175.91l22.71-22.54L364.54,256,262.7,358.63Z"></path>
            </g>
          </svg>
        </div>
        <div className="pl-10">
      ...
      <div className="flex justify-between ">
        <div>
          <img src="/logo.jpg" height="200px" width="200px" alt="" />
        </div>
